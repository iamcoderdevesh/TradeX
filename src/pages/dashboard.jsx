...
const dashboard = () => {
    return (
        <div className="p-4 bg-gray-50 dark:bg-gray-900 sm:ml-64">
            <div className="p-4 mt-14">
                ...
                <div className="grid grid-rows-1 gap-4 mb-4 lg:grid-cols-3">
                    <div className="flex flex-row justify-between h-24 rounded border border-gray-200 dark:border-gray-900 shadow-sm bg-white dark:bg-primary-dark">
                ...
                <div className="flex items-center justify-center h-48 mb-4 rounded bg-white dark:bg-primary-dark">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="flex items-center justify-center rounded bg-white h-28 dark:bg-primary-dark">
                        <p className="text-2xl text-gray-400 dark:text-gray-500">
                            <svg className="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 1v16M1 9h16" />
                            </svg>
