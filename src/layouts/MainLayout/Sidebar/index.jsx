...
const Sidebar = () => {
    ...
    return (
        <div>
            <aside id="logo-sidebar" className={`fixed top-0 left-0 w-64 h-screen transition-transform -translate-x-full ${activeMenu ? 'md:translate-x-0 -translate-x-full' : 'max-md:transform-none'} border-r border-gray-200 dark:border-gray-700`}>
