...
function InputField(props) {
    const { label, id, type, placeholder, disabled, require, handleChange, htmlName, value, errorMsg } = props;
    ...
    return (
        <>
            ...
            {errorMsg && <p className="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{errorMsg}</span></p>}
        </>
    );
}
